        ...
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
              ...
              Hritik Pandey
                ...
                <ButtonContainer>
                    <Button href="https://github.com/Hritik897" target="blank">Github</Button>
                    <Button href="www.linkedin.com/in/hritik-pandey-b73910225" target="blank">LinkedIn</Button>
                </ButtonContainer>
                    ...
                    isOpen && 
                            <MobileMenu isOpen={isOpen}>
                                ...
                                <MobileButtonContainer isOpen={isOpen}>
                                    <MobileButton href="https://github.com/Hritik897" target="blank">Github</MobileButton>
                                    <MobileButton href="www.linkedin.com/in/hritik-pandey-b73910225" target="blank">LinkedIn</MobileButton>
